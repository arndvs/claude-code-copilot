...
# 3. Add your OpenRouter API key to .env (primary upstream)
#    OPENROUTER_API_KEY=sk-or-...

# 4. Point Claude Code at the proxy
make claude-enable

# 5. Start the proxy (OpenRouter primary; GitHub OAuth on first Copilot fallback use)
make start
```
...
| `OPENROUTER_API_KEY` | OpenRouter API key — used for the primary upstream (default). Copilot is the fallback lane |
